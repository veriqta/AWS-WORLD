...
This area covers **Screenshots** within the broader AWS World repository. Store approved branding, diagrams, screenshots, recordings, templates, and attribution records used across AWS World.
...
**Repository path:** `Assets / Screenshots`
