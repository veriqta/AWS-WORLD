...
This area covers **Cli** within the broader AWS World repository. Store approved branding, diagrams, screenshots, recordings, templates, and attribution records used across AWS World.
...
**Repository path:** `Assets / Screenshots / Cli`
