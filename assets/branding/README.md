...
This area covers **Branding** within the broader AWS World repository. Store approved branding, diagrams, screenshots, recordings, templates, and attribution records used across AWS World.
...
- [Color Palette](color-palette/README.md)
- [Logos](logos/README.md)
- [Marks](marks/README.md)
- [Social Preview](social-preview/README.md)
...
**Repository path:** `Assets / Branding`
