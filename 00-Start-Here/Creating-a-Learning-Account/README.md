# Creating A Learning Account

[AWS World Home](../../README.md) | [Parent Section](../README.md)

## Purpose

This area covers **Creating A Learning Account** within the broader AWS World repository. Begin safely, choose a learning path, secure the AWS account, control costs, and prepare a working environment.
...
**Repository path:** `00 Start Here / Creating A Learning Account`
