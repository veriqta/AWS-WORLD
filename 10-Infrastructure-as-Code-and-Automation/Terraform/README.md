...
This area covers **Terraform** within the broader AWS World repository. Create repeatable AWS environments using CloudFormation, CDK, Terraform, OpenTofu, SAM, and automation tools.
...
**Repository path:** `10 Infrastructure As Code And Automation / Terraform`
