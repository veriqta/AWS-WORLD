...
This area covers **Cloudtrail** within the broader AWS World repository. Design secure identities, policies, organizations, landing zones, account boundaries, and governance controls.
...
**Repository path:** `03 Accounts Identity And Governance / Cloudtrail`
