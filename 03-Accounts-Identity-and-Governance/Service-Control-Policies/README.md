...
This area covers **Service Control Policies** within the broader AWS World repository. Design secure identities, policies, organizations, landing zones, account boundaries, and governance controls.
...
**Repository path:** `03 Accounts Identity And Governance / Service Control Policies`
