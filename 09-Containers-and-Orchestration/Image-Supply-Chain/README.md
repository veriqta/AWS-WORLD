...
This area covers **Image Supply Chain** within the broader AWS World repository. Run container workloads with ECR, ECS, EKS, Fargate, secure supply chains, and production operations.
...
**Repository path:** `09 Containers And Orchestration / Image Supply Chain`
