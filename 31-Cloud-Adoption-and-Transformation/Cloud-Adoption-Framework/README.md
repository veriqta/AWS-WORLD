...
This area covers **Cloud Adoption Framework** within the broader AWS World repository. Connect AWS engineering to business value, people, governance, platform, security, operations, and organizational change.
...
**Repository path:** `31 Cloud Adoption And Transformation / Cloud Adoption Framework`
