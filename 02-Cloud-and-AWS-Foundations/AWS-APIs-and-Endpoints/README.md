# Aws Apis And Endpoints

[AWS World Home](../../README.md) | [Parent Section](../README.md)

## Purpose

This area covers **Aws Apis And Endpoints** within the broader AWS World repository. Understand the cloud concepts, global infrastructure, APIs, endpoints, quotas, pricing, and design principles used throughout AWS.
...
**Repository path:** `02 Cloud And Aws Foundations / Aws Apis And Endpoints`
