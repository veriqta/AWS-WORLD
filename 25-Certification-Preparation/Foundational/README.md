...
This area covers **Foundational** within the broader AWS World repository. Prepare for current AWS certifications with maintained objectives, scenarios, labs, practice assessments, and readiness evidence.
...
- [Ai Practitioner](AI-Practitioner/README.md)
- [Cloud Practitioner](Cloud-Practitioner/README.md)
...
**Repository path:** `25 Certification Preparation / Foundational`
