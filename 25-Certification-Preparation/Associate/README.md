...
This area covers **Associate** within the broader AWS World repository. Prepare for current AWS certifications with maintained objectives, scenarios, labs, practice assessments, and readiness evidence.
...
- [Machine Learning Engineer](Machine-Learning-Engineer/README.md)
- [Solutions Architect](Solutions-Architect/README.md)
- [Sysops Administrator](SysOps-Administrator/README.md)
...
**Repository path:** `25 Certification Preparation / Associate`
