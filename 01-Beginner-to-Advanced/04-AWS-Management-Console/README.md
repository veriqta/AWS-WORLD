# 04 Aws Management Console

[AWS World Home](../../README.md) | [Parent Section](../README.md)

## Purpose

This area covers **04 Aws Management Console** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
**Repository path:** `01 Beginner To Advanced / 04 Aws Management Console`
