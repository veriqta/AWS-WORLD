...
This area covers **Beginner** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
- [Aws Global Infrastructure](AWS-Global-Infrastructure/README.md)
- [Cloud Fundamentals](Cloud-Fundamentals/README.md)
- [Core Services](Core-Services/README.md)
- [Identity Networking And Security](Identity-Networking-and-Security/README.md)
- [Monitoring And Costs](Monitoring-and-Costs/README.md)
...
**Repository path:** `01 Beginner To Advanced / Beginner`
