# 19 Cloudwatch And Cloudtrail

[AWS World Home](../../README.md) | [Parent Section](../README.md)

## Purpose

This area covers **19 Cloudwatch And Cloudtrail** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
**Repository path:** `01 Beginner To Advanced / 19 Cloudwatch And Cloudtrail`
