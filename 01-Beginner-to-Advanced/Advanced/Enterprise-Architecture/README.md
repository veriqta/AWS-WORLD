...
This area covers **Enterprise Architecture** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
**Repository path:** `01 Beginner To Advanced / Advanced / Enterprise Architecture`
