...
This area covers **17 Api Gateway** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
**Repository path:** `01 Beginner To Advanced / 17 Api Gateway`
