...
This area covers **Intermediate** within the broader AWS World repository. Follow the main progressive path from cloud fundamentals to production AWS engineering.
...
- [Architecture Fundamentals](Architecture-Fundamentals/README.md)
...
**Repository path:** `01 Beginner To Advanced / Intermediate`
