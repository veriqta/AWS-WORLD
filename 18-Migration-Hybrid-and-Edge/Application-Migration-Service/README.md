...
This area covers **Application Migration Service** within the broader AWS World repository. Assess, mobilize, migrate, validate, modernize, and operate hybrid and edge workloads.
...
**Repository path:** `18 Migration Hybrid And Edge / Application Migration Service`
