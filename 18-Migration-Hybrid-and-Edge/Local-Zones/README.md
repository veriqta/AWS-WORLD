...
This area covers **Local Zones** within the broader AWS World repository. Assess, mobilize, migrate, validate, modernize, and operate hybrid and edge workloads.
...
**Repository path:** `18 Migration Hybrid And Edge / Local Zones`
