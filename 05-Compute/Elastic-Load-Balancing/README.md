...
This area covers **Elastic Load Balancing** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
**Repository path:** `05 Compute / Elastic Load Balancing`
