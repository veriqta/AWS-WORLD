...
This area covers **Local Zones And Wavelength** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
**Repository path:** `05 Compute / Local Zones And Wavelength`
