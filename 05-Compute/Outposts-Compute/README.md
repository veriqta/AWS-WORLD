...
This area covers **Outposts Compute** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
**Repository path:** `05 Compute / Outposts Compute`
