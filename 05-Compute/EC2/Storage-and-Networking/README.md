...
This area covers **Storage And Networking** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
**Repository path:** `05 Compute / Ec2 / Storage And Networking`
