...
This area covers **Placement And Tenancy** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
**Repository path:** `05 Compute / Ec2 / Placement And Tenancy`
