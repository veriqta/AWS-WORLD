...
This area covers **Ec2** within the broader AWS World repository. Select, deploy, scale, secure, and operate AWS compute platforms.
...
- [Instance Lifecycle](Instance-Lifecycle/README.md)
- [Instances And Ami](Instances-and-AMI/README.md)
- [Placement And Tenancy](Placement-and-Tenancy/README.md)
- [Pricing And Purchasing](Pricing-and-Purchasing/README.md)
- [Storage And Networking](Storage-and-Networking/README.md)
...
**Repository path:** `05 Compute / Ec2`
