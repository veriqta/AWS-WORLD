...
This area covers **Operational Investigation** within the broader AWS World repository. Collect evidence, detect failures, operate services, and investigate AWS environments with metrics, logs, traces, events, and automation.
...
**Repository path:** `12 Observability And Cloudops / Operational Investigation`
