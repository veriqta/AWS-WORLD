...
This area covers **Metrics** within the broader AWS World repository. Collect evidence, detect failures, operate services, and investigate AWS environments with metrics, logs, traces, events, and automation.
...
**Repository path:** `12 Observability And Cloudops / Cloudwatch / Metrics`
