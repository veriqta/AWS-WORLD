...
This area covers **Security Foundations** within the broader AWS World repository. Apply identity, data, network, detection, response, audit, risk, and compliance controls across AWS.
...
**Repository path:** `14 Security Risk And Compliance / Security Foundations`
