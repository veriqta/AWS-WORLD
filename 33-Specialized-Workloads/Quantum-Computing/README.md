...
This area covers **Quantum Computing** within the broader AWS World repository. Explore AWS patterns for industries and specialized technologies such as IoT, media, HPC, healthcare, finance, and quantum computing.
...
**Repository path:** `33 Specialized Workloads / Quantum Computing`
