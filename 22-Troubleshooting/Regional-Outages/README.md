...
This area covers **Regional Outages** within the broader AWS World repository. Investigate AWS failures with evidence, hypotheses, exact checks, controlled fixes, recovery verification, and prevention.
...
**Repository path:** `22 Troubleshooting / Regional Outages`
