...
This area covers **Event Driven Architecture** within the broader AWS World repository. Build event-driven systems with functions, APIs, queues, topics, workflows, and managed integration services.
...
**Repository path:** `08 Serverless And Application Integration / Event Driven Architecture`
