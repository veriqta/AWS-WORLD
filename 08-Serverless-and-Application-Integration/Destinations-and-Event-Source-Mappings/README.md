# Destinations And Event Source Mappings

[AWS World Home](../../README.md) | [Parent Section](../README.md)

## Purpose

This area covers **Destinations And Event Source Mappings** within the broader AWS World repository. Build event-driven systems with functions, APIs, queues, topics, workflows, and managed integration services.
...
**Repository path:** `08 Serverless And Application Integration / Destinations And Event Source Mappings`
